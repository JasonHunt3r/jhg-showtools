...
//   axtool click <x> <y> [right|double|cmd|shift|opt|opt-double]
...
case "click":
    ...
    if mode == "right" {
        ...
        post(.leftMouseDown, p, clicks: 2, flags: .maskAlternate); post(.leftMouseUp, p, clicks: 2, flags: .maskAlternate)
